...
var CopyEmail = function () {
	function CopyEmail() {
		_classCallCheck(this, CopyEmail);

		this.copyEmail = (0, _jquery2.default)('.copy-email');
		this.mailTo = (0, _jquery2.default)('.mailto');
		this.copyEmailNotification = (0, _jquery2.default)('.copy-email-notification');
		this.events();
	}

	_createClass(CopyEmail, [{
		key: 'events',
...
var MobileMenu = function () {
	...
	function MobileMenu() {
		...
		this.menuContent = (0, _jquery2.default)('.header-navigation');
		this.menuListItem = (0, _jquery2.default)('.header-navigation li');
		this.events();
	}
	// Handle Click Events
...
var _CopyEmail = __webpack_require__(2);

var _CopyEmail2 = _interopRequireDefault(_CopyEmail);
